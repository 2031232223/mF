...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Future<void> _exportToCsv() async { ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('📤 Exportando...'), backgroundColor: Colors.red)); await Future.delayed(const Duration(seconds: 2)); if (mounted) ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('✅ Exportado'), backgroundColor: Colors.red)); }
