    ...
    if (sale.clienteId != null) {
      try {
        ...
        if (result.isNotEmpty) {
          nombreCliente = result.first['nombre'] as String;
        }
      } catch (e) {
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              if (sale.moneda != 'CUP')
                pw.Text('Moneda: ${sale.moneda} (Tasa: ${sale.tasaCambio})', style: pw.TextStyle(fontSize: 9)),
              ...
              if (sale.esFiado && sale.montoPendiente > 0)
                pw.Text('Pendiente: ${sale.moneda} ${sale.montoPendiente.toStringAsFixed(2)}', style: pw.TextStyle(fontSize: 10, color: PdfColors.orange)),
